      ...
      <table class="table table-striped">
        ...
        <c:forEach var="employeeModel" items="${employeeData}">
          <tr>
            ...
            <td>${employeeModel.departmentID}</td>
            <td>${employeeModel.hireDate}</td>
            <td>
              <div class="row">
                <div class="col">
                  <form action="delete-employee" method="get">
                    <button type="submit" class="btn btn-outline-danger" name="id" value="${employeeModel.employeeId}">Delete</button>
                  </form>
                </div>
                <div class="col">
                  <form action="update-employee-to-db.jsp" method="get">
                    <button type="submit" class="btn btn-outline-danger" name="id" value="${employeeModel.employeeId}">Edit</button>
                  </form>
                </div>
              </div>
            </td>
